...
<html lang="en">
  <head>
    ...
    <title><?php echo $GLOBALS['Config']->SiteName; ?> :: Database Query Error</title>
    ...
    <div class="container">
        <div class="panel panel-default text-center" style="margin-top:100px;">
            <div class="panel-body">
                <h1><i class="fa fa-database"></i> Database Query Error</h1>
                <p>Database Query could not be executed.</p>
